...
public class WorkoutDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(cardio.equals("1")){
            TextView cardio1 = (TextView) findViewById(R.id.textView3);
            cardio1.setText("Distance(km)");

            TextView cardio2 = (TextView) findViewById(R.id.textView);
            cardio2.setText("Time(Min)");
        }
