...
public class WorkoutDetailCopy extends AppCompatActivity {
    EditText weightForm;
    EditText repsForm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //gets exercise name
        Intent i = getIntent();
        Workout copy  =(Workout)getIntent().getSerializableExtra("copy");
        workout=copy;

        String ChoiseName = copy.getName();
        cardio = copy.getCardio();
        ...
        myCustomAdapter = new ArrayAdapterSets(WorkoutDetailCopy.this, workout);
        ...
        currentUserId.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                workoutNumber = dataSnapshot.child("workoutNumber").getValue(int.class);
                workoutNumber++;
            }
