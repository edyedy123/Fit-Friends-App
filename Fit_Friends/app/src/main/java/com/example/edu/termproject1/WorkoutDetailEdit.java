...
public class WorkoutDetailEdit extends AppCompatActivity {
    EditText weightForm;
    EditText repsForm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        workoutNumber = Integer.parseInt( box.getString("wNumber"));
        ...
        currentUserId.child("Workouts").child("Workout" + workoutNumber).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                workout = new Workout();
                workout=dataSnapshot.getValue(Workout.class);

                myCustomAdapter = new ArrayAdapterSets(WorkoutDetailEdit.this, workout);
