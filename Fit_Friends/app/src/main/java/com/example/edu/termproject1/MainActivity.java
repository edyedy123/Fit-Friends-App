       ...
       // /*
        ...
        expandableListView.setMultiChoiceModeListener(new AbsListView.MultiChoiceModeListener() {
            ...
            public void onItemCheckedStateChanged(ActionMode mode,
                ...
                pos=position;
                listAdapter.toggleSelection( expandableListView.getFlatListPosition(position));
                    ...
                    case R.id.delete:
                        ...
                        // Captures all selected ids with a loop
                            if (selected.valueAt(0)) {
                                Workout selecteditem = listAdapter.getGroup(selected.keyAt(0));
                    ...
                    case R.id.edit:
                        ...
                        // Captures all selected ids with a loop
                            if (selected1.valueAt(0)) {
                                Workout selecteditem = listAdapter.getGroup(selected1.keyAt(0));
